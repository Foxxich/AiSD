...
for x in range(1, 51):
    dataCSV = np.genfromtxt("C:\\Users\\Vadym\\Documents\\Lista4\\src\\2\\Lotr\\BST\\findElement"+str(x)+".txt",dtype='str',delimiter=',')
    dataCSV2 = np.genfromtxt("C:\\Users\\Vadym\\Documents\\Lista4\\src\\2\\Lotr\\RBT\\findElement"+str(x)+".txt",dtype='str',delimiter=',')
    dataCSV3 = np.genfromtxt("C:\\Users\\Vadym\\Documents\\Lista4\\src\\2\\Lotr\\SPLAY\\findElement"+str(x)+".txt",dtype='str',delimiter=',')
    for i in range(0,52):
    ...
    plotCompares.text(0, 15, "RBT", bbox=dict(facecolor='y', alpha=0.3))

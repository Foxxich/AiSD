...
arrayStat5 = []
npValueMQS = 0.127428
npValueQS = 19.425205000000002
npValueDUAL = 11.919844000000001
...
numberMQS = dataResultMQS[1]
numberQS = dataResultQS[1]
numberDUAL = dataResultDUAL[1]
...
plotCompares.savefig('Time100.png')
plotCompares.show()
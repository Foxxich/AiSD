...
plotCompares.plot(dataResult[4], dataResult[2],'r-')
plotCompares.plot(dataResult[4], dataResult1[2],'b-')
plotCompares.plot(dataResult[4], dataResult2[2],'y-')
plotCompares.plot(dataResult[4], dataResult3[2],'g-')
plotCompares.text(0, 0, "Select(random)", bbox=dict(facecolor='r', alpha=0.5))
plotCompares.text(0, 15000, "RandomSelect(random)", bbox=dict(facecolor='b', alpha=0.5))
plotCompares.text(00, 1000, "Select(permutation)", bbox=dict(facecolor='y', alpha=0.5))
plotCompares.text(0000, 17500, "RandomSelect(permutation)", bbox=dict(facecolor='g', alpha=0.5))
#xmarks=[i for i in range(0,100001,1)]
#plotCompares.xticks(xmarks)
plotCompares.savefig('comparisonAVG.png')
plotCompares.show()
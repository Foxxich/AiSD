...
plotCompares.plot(dataResult[4], dataResult[0],'r-')
plotCompares.plot(dataResult[4], dataResult1[0],'b-')
plotCompares.plot(dataResult[4], dataResult2[0],'y-')
plotCompares.plot(dataResult[4], dataResult3[0],'g-')
plotCompares.text(0, 700, "Select(random)", bbox=dict(facecolor='r', alpha=0.5))
plotCompares.text(0, 60000, "RandomSelect(random)", bbox=dict(facecolor='b', alpha=0.5))
plotCompares.text(100, 000, "Select(permutation)", bbox=dict(facecolor='y', alpha=0.5))
plotCompares.text(0000, 40000, "RandomSelect(permutation)", bbox=dict(facecolor='g', alpha=0.5))
#xmarks=[i for i in range(0,100001,1)]
#plotCompares.xticks(xmarks)
plotCompares.savefig('comparisonMAX.png')
plotCompares.show()
